  ...
  return (
    <section className="mb-16 animate-in fade-in slide-in-from-bottom-4 duration-1000 ease-out">
      <div className="flex flex-col items-center text-center mb-8">
        ...
        <h1 className="text-5xl md:text-6xl font-bold tracking-tight mb-4 text-[var(--text-primary)] cursor-default">
          <InteractiveGradientText>
            {data.name}
          </InteractiveGradientText>
        </h1>
        <p className="text-2xl font-medium text-[var(--text-secondary)] mb-6">
          {data.headline}
        </p>
        <p className="max-w-2xl text-lg text-[var(--text-muted)] leading-relaxed mb-10">
          {data.shortBio}
        </p>
        ...
        <div className="flex flex-wrap gap-4 justify-center items-center">
          <a
            ...
            className="flex items-center justify-center w-[144px] h-[40px] text-sm rounded-full bg-[var(--bg-inverse)] text-[var(--text-inverse)] font-medium border border-transparent hover:scale-105 hover:bg-[var(--color-electric-green)] hover:text-black transition-all duration-200"
          >
          ...
          <a
            ...
            className="flex items-center justify-center w-40 h-11 text-sm rounded-full border border-[var(--border-color)] hover:bg-transparent hover:border-[var(--color-electric-green)] hover:text-[var(--color-electric-green)] font-medium hover:scale-105 transition-all duration-200"
          >
